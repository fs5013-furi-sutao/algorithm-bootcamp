...
export const theme = {
  ...
  colors: {
    ...
    'blockquote-background': th.color('indigo-50'),
    'blockquote-border': th.color('indigo-200'),
    ...
    'table-border-color': th.color('gray-600'),
    'table-header-background-color': th.color('gray-200'),
    'table-header-font-color': th.color('gray-800'),
    ...
    modes: {
      dark: {
        ...
        'editor-background': th.color('gray-700'),
        ...
        'blockquote-background': th.color('gray-700'),
        'blockquote-border': th.color('gray-500'),
        ...
        'table-border-color': th.color('gray-600'),
        'table-header-background-color': th.color('gray-700'),
        'table-header-font-color': th.color('gray-100'),
        'table-data-background-color': th.color('white'),
        'table-data-font-color': th.color('gray-700'),
